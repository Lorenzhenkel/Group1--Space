...
#define vd_heating_pin 16 // Pin, to which regulates heating pannel 
#define vd_cooling_pin 17 // Pin, to which regulates peltier pannel 
...
// *insert PID funct* function to control heating and cooling blanket, changes nominal inside temperature according to outside temmperature
...
void loop(void) {
    //digitalWrite(vd_heating_pin, HIGH); 
  ...
  const uint8_t Binaries[] = {0b11111100, 0b10100000, 0b10110110, 0b10011110, 0b11001010, 0b11011100, 0b11111100, 0b11100000, 0b11111110, 0b11011110}; // for positiv values
...
if (temp_inside < 0) {
      sendDigit(Binaries[o[1]] + 1, SS_PIN_outside); // send right digit of outside temperature
}
else {
